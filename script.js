let first = null;
let second = "https://discord.gg/SzvrHBwyvn";
let third = "fivem://connect/147.135.221.74:30121";
...
function openLink(value) {
    ...
    if (value == "second") {
        window.location.href = "https://discord.gg/zp8gZ9UhZh";
    }
    if (value == "third") {
        window.location.href = "fivem://connect/venus.onicloud.fr:25593";
    }
    if (value == "start") {
...
function boutiqueSlide(value) {
    if (value == 1) {
        document.getElementsByClassName('intext')[0].style.transition = "all 1s";
        document.getElementsByClassName('intext')[0].style.right = "0vw";
        document.getElementsByClassName('boutique-title1')[0].style.borderBottom = "0.2vw solid rgb(60, 169, 24)";
        document.getElementsByClassName('boutique-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title4')[0].style.borderBottom = null;
    }
    if (value == 2) {
        document.getElementsByClassName('intext')[0].style.transition = "all 1s";
        document.getElementsByClassName('intext')[0].style.right = "40vw";
        document.getElementsByClassName('boutique-title1')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title2')[0].style.borderBottom = "0.2vw solid rgb(60, 169, 24)";
        document.getElementsByClassName('boutique-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title4')[0].style.borderBottom = null;
    }
    if (value == 3) {
        ...
        document.getElementsByClassName('boutique-title1')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title3')[0].style.borderBottom = "0.2vw solid rgb(60, 169, 24)";
        document.getElementsByClassName('boutique-title4')[0].style.borderBottom = null;
    }
    if (value == 4) {
        document.getElementsByClassName('intext')[0].style.transition = "all 1s";
        ...
        document.getElementsByClassName('boutique-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('boutique-title4')[0].style.borderBottom = "0.2vw solid rgb(60, 169, 24)";
    }
}
